...
import 'package:transportation_app/screens/ticket/components/passenger_data_form.dart';
                      ...
                      GestureDetector(
                        onTap: () async{
                          if(Platform.isIOS){
                            ...
                            provider.updateSelectedDepartureHour(time);
                          }
                          else{
                            showModalBottomSheet(
                              context: context, 
