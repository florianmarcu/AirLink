...
import 'private_arrival_trips_provider.dart';

class PrivateArrivalTripsPage extends StatelessWidget {
   @override
  Widget build(BuildContext context) {
    var wrapperHomePageProvider = context.watch<WrapperHomePageProvider>();
    var homeProvider = context.watch<HomePageProvider>();
    var provider = context.watch<PrivateArrivalTripsPageProvider>();
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
        ...
        title: Column(
          ...
          children: [
            Text("Alege tipul călătoriei întors", style: Theme.of(context).appBarTheme.titleTextStyle?.copyWith(fontSize: 20),),
            SizedBox(height: 5),
            ...
            Text.rich(TextSpan(children: [
              ...
              WidgetSpan(child: SizedBox(width: 10,)),
              TextSpan(
                text: "${formatDateToHourAndMinutes(homeProvider.selectedArrivalDateAndHour)}",
                style: Theme.of(context).textTheme.overline!.copyWith(fontSize: 16 )
              )
            ])),
