...
class ArrivalCupertinoHourPickerPage extends StatelessWidget {
  @override
        ...
        children: [
          Container(
            ...
            child: CupertinoDatePicker(
              initialDateTime: provider.selectedArrivalDateAndHour,
              use24hFormat: true,
              mode: CupertinoDatePickerMode.time,
              maximumDate: DateTime.now().toLocal().add(Duration(days: 90)),
              onDateTimeChanged: provider.updateSelectedArrivalHourIOS,
            ),
          ),
          SizedBox(height: 20,),
          TextButton(
